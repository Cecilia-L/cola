...
class UserpostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create userpost" do
    assert_difference('Userpost.count') do
      post userposts_url, params: { userpost: { content: @userpost.content, image: @userpost.image, user_id: @userpost.user_id } }
    end
  ...
  test "should update userpost" do
    patch userpost_url(@userpost), params: { userpost: { content: @userpost.content, image: @userpost.image, user_id: @userpost.user_id } }
